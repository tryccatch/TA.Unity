Shader "TA/13_NormalMap_Alpha"
{
    Properties
    {
        ...
        _BumpScale("Bump Scale", Range(0, 128)) = 1
        _AlphaScale("Alpha Scale", Range(0, 128)) = 1
        // _Specular("Specular Color", Color) = (1, 1, 1, 1)
        // _Gloss("Gloss", Range(10, 200)) = 20
    }
    SubShader
    {
        Tags { "Queue" = "Transparent" "IngnorProjector" = "Ture" "RenderType" = "Transparent" }
        Pass
        {
            ...
            fixed4 frag(v2f f) : SV_Target
            {
                ...
                fixed3 diffuse = _LightColor0.rgb * texColor.rgb * max(dot(tangentNoraml, lightDir),0);
