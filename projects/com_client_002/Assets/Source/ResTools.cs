...
public class ResTools
{
    ...
    public static Object Load(string orgRes,bool isLua=false,bool cache = true)
    {
        ...
        Debug.Log("对比版本文件：" + verPackage + "，" + verDownload);
        Object prefab;
    ...
    public static Object LoadDownload(string orgRes, string resKeyWithChannel,bool isLua)
    {
        ...
        try
        {
            ...
            Debug.Log("加载下载AB:" + Path.Combine(Application.persistentDataPath, resKeyWithChannel));
            if (bundle == null)
            {
    ...
    public static Object LoadPackage(string orgRes,string res,bool isLua) {       
        ...
        try
        {
            ...
            Debug.Log("加载 Package android AB:"+(Application.dataPath+"!assets/"+realRes));
#endif
            if (bundle == null) {
    ...
    private static string getKeyByPath(string tempPath)
    {
        ...
        if (filemap != null && filemap.ContainsKey(key)) {
            key = filemap[key];
            Debug.Log("有映射图片信息:原始路径=" + tempPath + "，value=" + key);
        }
        else
        {
            Debug.Log("没有映射图片信息:原始路径=" + tempPath + "，value=" + key);
        }
        return key;
    }
    ...
    static Dictionary<string, int> pakageVer;//存储本地ver.ver
    static Dictionary<string, int> downloadVer;//存储下载ver.ver
    ...
    public static void LoadConfig(LuaFunction fun)
    {
        ...
        //Debug.Log("1. 加载本地版本文件:"+(data == null));
        ...
        //Debug.Log("1. 加载本地channelFile:" + (channelFile == null));
        if (channelFile != null)
