...
{   
    static List<string> exclude = new List<string> {
       ...
       "CanvasRenderer","AudioSettings", "AnimatorControllerParameter",
       "Caching", "DrivenRectTransformTracker", "Input", "LightProbeGroup",
       "Light", "QualitySettings", "Texture", "Graphic", 
       ...
       get
       {
           ...
           var customTypes = (from assembly in customAssemblys.Select(s => Assembly.Load(s))
                              ...
                              where type.Namespace == null || 
									!type.Namespace.StartsWith("XLua") && !type.Namespace.StartsWith("Games.Coresdk") 
									&& !type.Namespace.StartsWith("DG") && !type.Namespace.StartsWith("DragonBones") 
                                    && !type.Namespace.StartsWith("H365")
                                    && !type.Namespace.StartsWith("ICSharpCode")
                                    && type.BaseType != typeof(MulticastDelegate) && !type.IsInterface && !type.IsEnum
                              select type);
